        ...
        const streamPartsTransformer = new TransformStream({
            transform: async (chunk, controller)=>{
                ...
                switch(chunkType){
                    ...
                    case "error":
                        {
                            controller.enqueue((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$ui$2d$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["formatStreamPart"])("error", getErrorMessage3(chunk.error)));
                            break;
                        }
                    case "step-finish":
                        {
...
function createEventStreamTransformer(customParser) {
    ...
    return new TransformStream({
        async start (controller) {
            eventSourceParser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$node_modules$2f$eventsource$2d$parser$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createParser"])((event)=>{
